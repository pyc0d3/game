...
PLAYER_RUN = [pg.transform.scale(sprite, (TILESIZE, TILESIZE)) for sprite in PLAYER_RUN]
...
PLAYER_IDE = [pg.transform.scale(sprite, (TILESIZE, TILESIZE)) for sprite in PLAYER_IDE]
...
WALL_SPRITE = {sprite : pg.transform.scale(WALL_SPRITE[sprite], (TILESIZE, TILESIZE)) for sprite in WALL_SPRITE}
...
TRAPDOOR_SPRITE = {sprite : pg.transform.scale(TRAPDOOR_SPRITE[sprite], (TILESIZE, TILESIZE)) for sprite in TRAPDOOR_SPRITE}